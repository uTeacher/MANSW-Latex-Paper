...
Getting everything fitting nicely onto A4 paper can be a challenge if you're expecting to hand everything out. You can spend ages getting it all perfect (and would the student's even notice all the work?) or you can get a pretty reasonable result with a minimum of additional effort.
